...
@Component({
    ...
    <div class="dashboard-overview-container">
      ...
      <div class="welcome-banner glass-panel">
        ...
        <div class="welcome-actions">
          <button mat-flat-button color="primary" class="glow-button" routerLink="/dashboard/master-data/company">
      ...
      <div class="kpi-grid">
        ...
        <mat-card class="kpi-card glass-card hover-lift" routerLink="/dashboard/workforce/attendance">
        ...
        <mat-card class="kpi-card glass-card hover-lift" routerLink="/dashboard/workforce/leaves">
        ...
        <mat-card class="kpi-card glass-card hover-lift" routerLink="/dashboard/crm/leads">
        ...
        <mat-card class="kpi-card glass-card hover-lift" routerLink="/dashboard/crm/tickets">
      ...
      <div class="content-grid">
        ...
        <mat-card class="chart-card glass-card">
          <mat-card-header>
            ...
            <button mat-icon-button [matMenuTriggerFor]="deptMenu"><mat-icon>more_vert</mat-icon></button>
            <mat-menu #deptMenu="matMenu">
              <button mat-menu-item routerLink="/dashboard/master-data/department">
          ...
          <mat-card-content>
            <div class="department-list">
              ...
              <div class="dept-item">
                ...
                <mat-progress-bar mode="determinate" value="55" class="progress-success"></mat-progress-bar>
              </div>
              <div class="dept-item">
                <div class="dept-info">
                ...
                <mat-progress-bar mode="determinate" value="45" class="progress-warning"></mat-progress-bar>
              </div>
              <div class="dept-item">
                <div class="dept-info">
                ...
                <mat-progress-bar mode="determinate" value="30" class="progress-danger"></mat-progress-bar>
              </div>
            </div>
          </mat-card-content>
        </mat-card>
        ...
        <mat-card class="activity-card glass-card">
          <mat-card-header>
            ...
            <button mat-button color="primary" routerLink="/dashboard/workforce/attendance">View All</button>
          </mat-card-header>
          <mat-card-content>
            <div class="activity-feed">
              ...
              <div class="activity-item">
                ...
                <div class="activity-details">
                  <p><strong>System Alert</strong> SLA breached on Ticket #492</p>
  ...
  styles: [`
    ...
    .primary-glow { background: rgba(99,102,241,0.15); color: #818cf8; border: 1px solid rgba(99,102,241,0.3); }
    .warning-glow { background: rgba(245,158,11,0.15); color: #fbbf24; border: 1px solid rgba(245,158,11,0.3); }
    .success-glow { background: rgba(16,185,129,0.15); color: #34d399; border: 1px solid rgba(16,185,129,0.3); }
    .danger-glow  { background: rgba(239,68,68,0.15); color: #f87171; border: 1px solid rgba(239,68,68,0.3); }
    ...
    .dept-count { color: #94a3b8; }
    
    ::ng-deep .progress-success .mdc-linear-progress__bar-inner { border-color: #34d399 !important; }
    ::ng-deep .progress-warning .mdc-linear-progress__bar-inner { border-color: #fbbf24 !important; }
    ::ng-deep .progress-danger .mdc-linear-progress__bar-inner { border-color: #f87171 !important; }
    ::ng-deep .mdc-linear-progress__buffer { background-color: rgba(255,255,255,0.05) !important; }
