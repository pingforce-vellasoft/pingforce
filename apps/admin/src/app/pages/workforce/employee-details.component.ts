...
@Component({
      ...
      <div class="grid-layout">
        ...
        <div class="sidebar-column">
          ...
          <div class="glass-panel profile-card">
            ...
            <p class="role-text">{{ getMockEmployee().designation }} &bull; {{ getMockEmployee().department }}</p>
            ...
            <div class="metric-row">
              ...
              <div class="metric-box">
                <span class="metric-value shortfall" [class.no-shortfall]="getMockEmployee().shortfalls === 0">{{ getMockEmployee().shortfalls }}</span>
          ...
          <div class="glass-panel details-panel" style="margin-top: 24px;">
            <h3><mat-icon class="panel-icon">contact_mail</mat-icon> Contact Information</h3>
            <div class="info-list">
              <div class="info-item">
        ...
        <div class="details-column">
          ...
          <div class="glass-panel details-panel">
            <h3><mat-icon class="panel-icon">badge</mat-icon> Employment Details</h3>
          ...
          <!-- Leave Balances -->
          <div class="glass-panel details-panel" style="margin-top: 24px;">
            <h3><mat-icon class="panel-icon">event_available</mat-icon> Leave Balances ({{ getMockEmployee().totalLeaves }} Total)</h3>
            <div class="leave-grid">
              <div class="leave-card" *ngFor="let leave of getMockEmployee().leaveBreakdown">
                <div class="leave-header">
                  <span class="leave-type">{{ leave.type }}</span>
                  <span class="leave-count">{{ leave.available }} / {{ leave.total }}</span>
                </div>
                <mat-progress-bar mode="determinate" [value]="(leave.available / leave.total) * 100" [color]="leave.color"></mat-progress-bar>
          ...
          <div class="glass-panel details-panel" style="margin-top: 24px;">
            <h3><mat-icon class="panel-icon">timeline</mat-icon> Activity Timeline</h3>
            <div class="empty-state">
              <mat-icon class="empty-icon">pending_actions</mat-icon>
              <h4>No recent activity</h4>
              <p>Activity timeline module will be integrated in the next phase.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  styles: [`
    ...
    ::ng-deep .mat-mdc-progress-bar[color="primary"] .mdc-linear-progress__bar-inner {
      border-color: #6366f1 !important;
    }
    ::ng-deep .mat-mdc-progress-bar[color="accent"] .mdc-linear-progress__bar-inner {
      border-color: #22c55e !important;
    }
    ::ng-deep .mat-mdc-progress-bar[color="warn"] .mdc-linear-progress__bar-inner {
    ...
    .empty-state h4 { margin: 0; color: #cbd5e1; font-weight: 500; font-size: 16px; }
    .empty-state p { color: #64748b; margin-top: 8px; font-size: 14px; }
  `]
})
