  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        ...
        <p class="page-subtitle">Manage access control roles and configure fine-grained permissions.</p>
      </div>
    
      <div class="actions-bar">
        <button mat-flat-button color="primary" class="create-btn" (click)="openCreateRoleDialog()">
      ...
      <div class="table-container">
        <table mat-table [dataSource]="dataSource" class="premium-table">
          ...
          <ng-container matColumnDef="system">
            ...
            <td mat-cell *matCellDef="let element">
              <span class="status-badge" [class.system]="element.isSystem" [class.custom]="!element.isSystem">
          ...
          <ng-container matColumnDef="actions">
            ...
            <td mat-cell *matCellDef="let element" class="action-cell">
              <div class="actions-wrapper">
                @if (!element.isSystem) {
                  <button mat-icon-button class="action-btn" (click)="editRole(element)" title="Edit Role">
                    <mat-icon>edit</mat-icon>
                  </button>
                }
                <button mat-icon-button class="action-btn" (click)="openPermissionsDialog(element)" title="Manage Permissions">
                  <mat-icon>security</mat-icon>
                </button>
                @if (!element.isSystem) {
                  <button mat-icon-button class="action-btn delete-btn" (click)="deleteRole(element)" title="Delete Role">
