    ...
    <mat-card class="table-container">
      <table mat-table [dataSource]="dataSource">
        ...
        <ng-container matColumnDef="leaveType">
          ...
          <td mat-cell *matCellDef="let element"> {{element.leaveType?.name || 'Standard Leave'}} </td>
        </ng-container>
        ...
        <ng-container matColumnDef="actions">
          ...
          <td mat-cell *matCellDef="let element" class="action-cell">
            <button mat-flat-button color="primary" class="action-btn" (click)="approve(element.id)">
              <mat-icon>check</mat-icon> Approve
            </button>
            <button mat-stroked-button color="warn" class="action-btn" (click)="reject(element.id)">
