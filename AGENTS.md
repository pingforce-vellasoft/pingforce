# AGENTS.md — PingForce Monorepo

> AI engineering reference for Codex. Replaces missing NestJS, Prisma, Angular, NX, Docker, and GitHub Actions skills.
...
All AI output (including from Codex) MUST pass:
