...
@Component({
  ...
  template: `
    <h2 mat-dialog-title>{{ data.isEdit ? 'Edit' : 'Create' }} {{ getTypeName() }}</h2>
    <mat-dialog-content>
      <form [formGroup]="form" class="form-container">
        ...
        <mat-form-field appearance="outline" class="full-width">
          ...
          <input matInput formControlName="code" placeholder="Enter code (e.g. BR-01)">
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-flat-button color="primary" [disabled]="form.invalid || isLoading" (click)="onSave()">
...
export class MasterDataDialogComponent {
  ...
  onSave() {
    ...
    const request = this.data.isEdit
      ? this.masterDataService.update(this.data.type, this.data.item!.id, this.form.value)
