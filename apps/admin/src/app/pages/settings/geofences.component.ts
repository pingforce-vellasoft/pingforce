...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatCardModule, MatInputModule, MatButtonModule, MatTableModule, MatIconModule, FormsModule, MatDialogModule, OverlayModule],
  template: `
    <div class="page-container">
      <div class="header-section">
        <div>
          <h1 class="page-title">Geofence Intelligence</h1>
          <p class="page-subtitle">Configure spatial boundaries for biometric attendance</p>
        </div>
      </div>
          ...
          <mat-card class="premium-card">
            ...
            <div class="form-content">
              <mat-form-field appearance="outline" class="full-width">
                ...
                <input matInput [(ngModel)]="newGeofence.name" placeholder="e.g. Headquarters, NY Branch">
              ...
              <div class="row">
                <mat-form-field appearance="outline">
                  ...
                  <input matInput type="number" [(ngModel)]="newGeofence.latitude" placeholder="40.7128">
                  <mat-icon matPrefix class="field-icon">explore</mat-icon>
                </mat-form-field>
                <mat-form-field appearance="outline">
                  <mat-label>Longitude</mat-label>
                  <input matInput type="number" [(ngModel)]="newGeofence.longitude" placeholder="-74.0060">
                  <mat-icon matPrefix class="field-icon">explore</mat-icon>
                </mat-form-field>
              </div>
              ...
              <mat-form-field appearance="outline" class="full-width">
                ...
                <input matInput type="number" [(ngModel)]="newGeofence.radiusMeters">
                <mat-icon matPrefix class="field-icon">radar</mat-icon>
                <mat-hint>Recommended: 50 - 200 meters</mat-hint>
              </mat-form-field>
    
              <button mat-flat-button class="submit-btn" (click)="saveGeofence()">
          ...
          <div class="table-wrapper">
            <table mat-table [dataSource]="geofences" class="premium-table">
              ...
              <ng-container matColumnDef="name">
                <th mat-header-cell *matHeaderCellDef> <mat-icon class="header-icon">business</mat-icon> Location </th>
              ...
              <ng-container matColumnDef="coordinates">
                <th mat-header-cell *matHeaderCellDef> <mat-icon class="header-icon">my_location</mat-icon> Coordinates </th>
                <td mat-cell *matCellDef="let element">
                  <div class="coord-hover-container"
                    cdkOverlayOrigin
                    #trigger="cdkOverlayOrigin"
                    (mouseenter)="element.showMap = true"
                    (mouseleave)="element.showMap = false">
                    <span class="coord-pill interactive-pill">{{element.latitude | number:'1.2-4'}}, {{element.longitude | number:'1.2-4'}}</span>
                  </div>
              ...
              <ng-container matColumnDef="radius">
                <th mat-header-cell *matHeaderCellDef> <mat-icon class="header-icon">radar</mat-icon> Radius </th>
                <td mat-cell *matCellDef="let element">
              ...
              <ng-container matColumnDef="actions">
                ...
                <td mat-cell *matCellDef="let element" style="text-align: right">
                  <button mat-icon-button class="delete-btn" (click)="deleteGeofence(element.id)">
  ...
  styles: [`
    ...
    .page-subtitle { color: #94a3b8; margin: 8px 0 0 0; font-size: 15px; }
    ...
    .card-header h3 { margin: 0; font-size: 18px; font-weight: 600; color: #f1f5f9; }
    ...
    .field-icon { color: #64748b; margin-right: 8px; }
    ::ng-deep .mat-mdc-input-element { color: #f8fafc !important; }
    ::ng-deep .mat-mdc-form-field-label { color: #94a3b8 !important; font-weight: 500; }
    ::ng-deep .mat-mdc-form-field-subscript-wrapper { padding-left: 0; }
    ::ng-deep .mat-mdc-form-field-hint { color: #64748b; font-size: 12px; margin-top: 4px; }
    ...
    .premium-row { transition: background 0.2s ease; }
    .premium-row:hover { background: rgba(255, 255, 255, 0.02) !important; }

    .header-icon {
      font-size: 16px; width: 16px; height: 16px;
      vertical-align: text-bottom; margin-right: 4px; color: #64748b;
    }

    .loc-name { font-weight: 600; font-size: 15px; color: #f8fafc; }
    ...
    .empty-icon { font-size: 48px; width: 48px; height: 48px; color: #475569; margin-bottom: 16px; }
...
export class GeofenceSettingsComponent implements OnInit {
  ...
  loadGeofences() {
    this.http.get<any[]>('/api/v1/attendance/geofence').subscribe({
      next: (data) => {
        this.geofences = (data || []).map((g: any) => ({...g, mapUrl: this.getMapUrl(g.latitude, g.longitude)}));
      },
  ...
  saveGeofence() {
    ...
    this.http.post('/api/v1/attendance/geofence', payload).subscribe({
      next: () => {
        this.loadGeofences();
        this.newGeofence = { name: '', latitude: 0, longitude: 0, radiusMeters: 50 };
      },
      error: (err) => {
          console.error(err);
